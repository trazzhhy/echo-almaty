    ...
    <article className="border border-border bg-card p-5">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <h2 className="mt-1 font-heading text-xl font-bold">{author.name}</h2>
        </div>
        <span className="border border-border bg-secondary px-2.5 py-1 text-sm font-semibold text-secondary-foreground">
